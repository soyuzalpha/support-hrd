...
export function DateTimePicker({
  ...
  const formatDisplayDate = (d: Date) => {
    if (includeTime) {
      return timeFormat === "12" ? format(d, "dd-MM-yyyy hh:mm a") : format(d, "dd-MM-yyyy HH:mm");
    }
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          ...
          {initialDate ? formatDisplayDate(initialDate) : placeholder}
        </Button>
      </PopoverTrigger>
      ...
      <PopoverContent className="w-auto p-0 z-50" align="start" side="bottom" sideOffset={6} avoidCollisions>
        <div className="p-3">
          <Calendar
            ...
            initialFocus
            captionLayout={withYear ? "dropdown-years" : "label"}
            fromYear={withYear ? fromYear : undefined}
            toYear={withYear ? toYear : undefined}
          />
          ...
          {includeTime && (
            <>
              ...
              <div className="space-y-2">
                ...
                <Input type="time" value={timeValue} onChange={(e) => handleTimeChange(e.target.value)} />
...
/** Backward compatible */
export function DatePicker(props: Omit<DateTimePickerProps, "includeTime">) {
