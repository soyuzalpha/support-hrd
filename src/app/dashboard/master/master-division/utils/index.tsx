...
export const formSchemaDivision = z.object({
  id_division: z.number().optional().nullable(),
  name_division: z
    .string()
    .nonempty("Position name is required.")
    .min(2, "Bug title must be at least 2 characters.")
    .max(32, "Bug title must be at most 32 characters."),
  description_division: z.string().max(100, "Description must be at most 100 characters."),
  status: z.object({
    label: z.string(),
    value: z.string(),
  }),
...
export const columnsMasterDivision = ({ onClickDetail, onClickEdit, onClickData }) => {
  return [
    ...
    columnHelper.accessor("name_division", {
      header: "Division Name",
      cell: (info) => <p>{info.getValue()}</p>,
    }),
    columnHelper.accessor("description_division", {
      header: "Description",
