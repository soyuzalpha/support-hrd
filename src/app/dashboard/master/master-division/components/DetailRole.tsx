              ...
              <div className="flex items-start justify-between mb-4">
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <h1 className="text-4xl font-bold ">{details.name_division}</h1>
                    <span
                  ...
                  <p className=" text-xs">Position ID: #{details.id_division}</p>
                </div>
              </div>
              ...
              <GlassContainer>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className=" leading-relaxed">{details.description_division}</p>
                  </div>
                </div>
              </GlassContainer>
            </div>
