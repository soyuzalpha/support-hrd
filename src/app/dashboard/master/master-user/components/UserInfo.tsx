      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 mb-6">
        <div className="flex items-start gap-6">
          <div className="w-24 h-24 bg-linear-to-br from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center text-white text-3xl font-bold shadow-lg">
            {employeeData?.employees?.nick_name?.charAt(0) || employeeData?.name?.charAt(0) || "?"}
          </div>
          <div className="flex-1">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">{employeeData?.employees?.full_name || employeeData?.name || "-"}</h1>
          ...
          <div className="text-right">
            <span className="inline-block px-4 py-2 bg-green-100 text-green-700 rounded-full text-xs font-medium">
              {employeeData?.employments?.status?.toUpperCase() || "UNKNOWN"}
            </span>
          </div>
        </div>
      </div>
        ...
        <div className="p-8">
            ...
            <div className="space-y-6">
              {employeeData.employees ? (
                <>
                  ...
                  {employeeData.employees.address && (
                ...
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <h3 className="text-lg font-semibold text-gray-600 mb-2">No Personal Data</h3>
                  <p className="text-sm text-gray-500">Personal information is not available for this user.</p>
                </div>
              )}
            </div>
          )}
            ...
            <div className="space-y-6">
              {employeeData.employments ? (
                <>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <InfoItem
                      label="Manager"
                      value={
                        employeeData.employments?.manager
                          ? `${employeeData.employments.manager.name} (${employeeData.employments.manager.employee_number})`
                          : "-"
                      }
                    />
                  </div>

                  {employeeData.employees?.workhistory && employeeData.employees.workhistory.length > 0 && (
                ...
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <h3 className="text-lg font-semibold text-gray-600 mb-2">No Employment Data</h3>
                  <p className="text-sm text-gray-500">Employment information is not available for this user.</p>
                </div>
              )}
            </div>
          )}
          ...
          {activeTab === "education" && (
            <div className="space-y-4">
              {employeeData.employees?.educationhistory && employeeData.employees.educationhistory.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <h3 className="text-lg font-semibold text-gray-600 mb-2">No Education Data</h3>
                  <p className="text-sm text-gray-500">Education history is not available for this user.</p>
                </div>
              )}
            </div>
          )}
          ...
          {activeTab === "family" && (
            <div className="space-y-4">
              {employeeData.employees?.family && employeeData.employees.family.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <h3 className="text-lg font-semibold text-gray-600 mb-2">No Family Data</h3>
                  <p className="text-sm text-gray-500">Family information is not available for this user.</p>
                </div>
              )}
            </div>
          )}
          ...
          {activeTab === "leave" && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {employeeData.leave_quotas && employeeData.leave_quotas.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-gray-800">{leave.total_days || 0}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Used Days:</span>
                        <span className="font-medium text-red-600">{leave.used_days || 0}</span>
                      </div>
                      <div className="flex justify-between pt-2 border-t border-green-200">
                        <span className="text-gray-600 font-medium">Remaining:</span>
                        <span className="font-bold text-green-600 text-lg">{leave.remaining_days || 0}</span>
                      </div>
                    </div>
                  </div>
                ))
                ...
                <div className="col-span-2 flex flex-col items-center justify-center py-12">
                  ...
                  <h3 className="text-lg font-semibold text-gray-600 mb-2">No Leave Quota Data</h3>
                  <p className="text-sm text-gray-500">Leave quota information is not available for this user.</p>
                </div>
              )}
            </div>
          )}
