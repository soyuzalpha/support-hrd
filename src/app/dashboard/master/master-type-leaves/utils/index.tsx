...
export const columnsMasterPositions = ({ onClickDetail, onClickEdit, onClickData }) => {
  return [
    ...
    columnHelper.accessor("name_typeleave", {
      header: "Name Type Leave",
    ...
    columnHelper.accessor("gender_specific", {
      header: "Gender Spesific",
      cell: (info) => <p className="text-wrap">{info.getValue() ?? "-"}</p>,
    }),
