...
import { getPeriodAttendances, deletePeriodAttendance } from "./api/attendance-period-service";
import { DataTable } from "@/components/data-table";
import { columnsPeriodAttendance } from "./utils/index";
...
import FormAttendancePeriod from "./components/FormAttendancePeriod";
...
const Period = () => {
  ...
  const {
    ...
    queryKey: "period-attendances",
    queryFn: getPeriodAttendances,
    initialParams: {
      page: 1,
      limit: 10,
      searchKey: "",
  ...
  const mutationDeactive = useMutation({
    mutationFn: deletePeriodAttendance,
  });
  ...
  return (
    <FormProvider {...fForm}>
      <DataTable
        ...
        withFilter={false}
        columns={columnsPeriodAttendance({
          onClickData: (row) => {
