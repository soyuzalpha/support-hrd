...
export const columnsEmployeeWarning = ({ onClickDetail, onClickEdit, onClickData }) => {
  return [
    columnHelper.accessor("employee_data.full_name", {
      header: "Name",
      cell: (info) => <p>{info.getValue()}</p>,
    }),
    columnHelper.accessor("warning_year", {
      header: "Warning Year",
      cell: (info) => <p>{info.getValue()}</p>,
    }),
    columnHelper.accessor("warning_level", {
      header: "Warning Level",
      cell: (info) => <p>{info.getValue()}</p>,
    }),
    columnHelper.accessor("warning_reason", {
      header: "Warning Reason",
      cell: (info) => <p>{info.getValue()}</p>,
    }),
