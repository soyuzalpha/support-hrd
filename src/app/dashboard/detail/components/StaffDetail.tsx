...
//             <div className="flex flex-col items-end gap-3">
//               <Button type="button" variant={"glassInfo"} onClick={handleClickDetail}>
//                 <Pencil />
//               </Button>
//               <div className="flex flex-wrap gap-2 justify-end">
//                 <Badge variant="secondary" className="bg-white/90 text-blue-900">
...
//       {/* ── Tabs — flex row, same total width as header (w-full container) ── */}
//       {/*
//         Layout: [sidebar 192px fixed] [gap 12px] [content flex-1]
//         Both together = 100% of container = same width as header above.
//         No col-span math needed — flex-1 fills whatever remains.
//       */}
//       <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
//         <div className="flex gap-3 items-start w-full">
//           {/* ── Left sidebar ──────────────────────────────────────────── */}
...
//                 <CardHeader>
//                   <CardTitle className="text-base flex items-center gap-2">
//                     <FileText className="w-4 h-4" /> Identity Information
//                   </CardTitle>
//                 </CardHeader>
//                 <CardContent>
//                   <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-0">
...
//                     </div>
//                     <div>
//                       <p className="text-xs font-semibold uppercase tracking-wide text-gray-400 mb-1">Phone Numbers</p>
//                       {staffData?.contacts?.map((contact: any) => (
//                         <InfoRow key={contact?.id_contact} label="Phone" value={contact?.phone_number} icon={Phone} />
//                       ))}
//                     </div>
